...
public class JsonObjParse {
	...
	public static void main(String[] args) {
		...
		// String email = "[\"morampudi.nagababu1@postnordstg.onmicrosoft.com\",\"Dummy@abc.com\"]";
		 String email = "[\"morampudi.nagababu1@postnordstg.onmicrosoft.com\",\"Dummy@abc.com\",\"Dumm1@abc.com\"]";
		 ...
		 for(int i=0;i<emailArr.length;i++) {
			 if(i==0) {
				 System.out.println("After Parsed Email "+0 +":" +emailArr[i].substring(2, emailArr[i].toString().length()-1));
			 }else if (i==emailArr.length-1) {
				 System.out.println("AFter Parsed Email "+1 +":" +emailArr[i].substring(1, emailArr[i].toString().length()-2));
			 }else {
				 System.out.println("AFter Parsed Email "+2 +":" +emailArr[i].substring(1, emailArr[i].toString().length()-1));
